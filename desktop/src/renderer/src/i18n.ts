...
export const messages: Record<string, Entry> = {
  ...
  'sync.pairsHint': { ko: '내 컴퓨터의 폴더를 GenyDrive에 연결합니다. 연결된 폴더는 에이전트 저장소의 하위 폴더로 나타나고, GenyDrive 폴더 안에는 바로가기가 생깁니다.', en: 'Connect a folder on this computer into GenyDrive. It appears as a subfolder of the agent workspace, with a shortcut inside the GenyDrive folder.' },
