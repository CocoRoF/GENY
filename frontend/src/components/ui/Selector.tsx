        ...
        className={cn(
          ...
          isField
            ? cn(
                ...
                // sm == unified toolbar height (h-8, same as ActionButton /
                // IconButton) so selectors line up exactly in action rows;
                // md (forms) stays roomier.
                size === 'sm'
            ...
            : cn(
                ...
                size === 'sm' ? 'h-8 text-[0.75rem]' : 'h-8 text-[0.8125rem]',
              ),
