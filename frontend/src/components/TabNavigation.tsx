...
const GLOBAL_TAB_IDS = ['main', 'playground', 'playground2d', 'toolSets', 'environments', 'sharedFolder', 'admin', 'settings'] as const;
...
const DEV_ONLY_GLOBAL = new Set(['toolSets', 'environments', 'admin', 'settings']);
