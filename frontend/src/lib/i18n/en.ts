...
const en = {
  ...
  settings: {
    ...
    llmBackends: {
      ...
      title: 'LLM Backends',
      description: 'Six providers map to the executor\'s ClientRegistry. Each card is the single editor for that provider — click to paste an API key (Anthropic / OpenAI / Google / vLLM) or run the in-modal login flow (Claude Code, Copilot). Once a card turns green any Environment whose Stage 6 picks that provider routes actual VTuber / Worker sessions through it.',
      ...
      detail: {
        ...
        'copilot.login_required': '{path} · {version} · `gh auth login` required.',
        'copilot.extension_missing': '{path} · {version} · install `github/gh-copilot` extension.',
      } as Record<string, string>,
      installHelp: {
      ...
      // Copilot modal
      copilotModal: {
        title: 'GitHub Copilot (CLI) — Authentication',
        sectionStatus: 'Status',
        sectionSignIn: 'Sign in',
        startLogin: 'Start gh auth login (web)',
        loggedIn: 'logged in',
        ...
        extensionMissingIntro: 'You\'re logged into GitHub but the Copilot CLI extension isn\'t installed. SSH into the host and run:',
        extensionMissingOutro: 'Then hit Refresh above.',
        signOutConfirm: 'Sign out of gh on the server? You\'ll have to log in again to use Copilot CLI.',
      },
    },
  },
