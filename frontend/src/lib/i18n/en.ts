...
const en = {
  ...
  googleSettings: {
    ...
    guideStep4: 'Go to "Credentials → Create credentials → OAuth client ID" and choose application type "TV and Limited Input devices" (this type is what enables device flow).',
    guideStep5: 'Paste the generated client ID and client secret into the fields below and click "Save".',
    guideStep6: 'Click "Connect", open the shown URL, enter the code, and approve. Done.',
    guideOpenConsole: 'Open Google Cloud Console',
    clientSection: 'OAuth client',
    clientSet: 'Set',
    clientUnset: 'Not set',
    clientHelper: 'Paste the client ID and secret of the "TV and Limited Input devices" OAuth client you created via the steps above.',
    clientId: 'Client ID',
