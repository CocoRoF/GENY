...
const en = {
  ...
  personaPresets: {
    ...
    subtitle: 'Build a character\'s personality from MBTI / Enneagram / archetype + OCEAN & expressive-style sliders + speech & emotion. A saved preset, attached to an environment in the editor\'s Persona panel, is compiled into the system prompt.',
    new: 'New preset',
    loading: 'Loading…',
    failed: 'Failed: {error}',
    ...
    empty: {
      ...
      desc: 'Create a character personality with "New preset". Built-in starters (cheerful / tsundere / kuudere / professional) are included too.',
    },
    sections: {
      basic: 'Basics',
  ...
  envManagement: {
    ...
    globals: {
      ...
      persona: {
        ...
        description: 'Pick the character personality applied to this environment\'s sessions. The selected preset is prepended to the system prompt so the character identity leads, ahead of the role/behaviour rules. Build presets in the "Persona Presets" tab.',
      },
