...
const ko: Translations = {
  ...
  personaPresets: {
    title: '페르소나 프리셋',
    subtitle: 'MBTI·에니어그램·캐릭터 아키타입 + 성격(OCEAN)·표현 슬라이더 + 말투·감정으로 캐릭터 성격을 만듭니다. 저장한 프리셋은 환경 편집기 「페르소나」에서 환경에 적용하면 시스템 프롬프트로 주입됩니다.',
    new: '새 프리셋',
    loading: '불러오는 중…',
    failed: '실패: {error}',
    ...
    empty: {
      title: '아직 프리셋이 없습니다',
      desc: '「새 프리셋」으로 캐릭터 성격을 만들어 보세요. 기본 제공 프리셋(밝은 친구·츤데레·쿨데레·프로 비서)도 있습니다.',
    },
    sections: {
      basic: '기본 정보',
      framework: '프레임워크',
  ...
  envManagement: {
    ...
    globals: {
      ...
      persona: {
        title: '페르소나 프리셋',
        description: '이 환경의 세션에 적용할 캐릭터 성격(페르소나)을 선택합니다. 선택한 프리셋은 시스템 프롬프트 맨 앞에 주입되어 캐릭터 정체성이 역할/행동 규칙보다 먼저 자리잡습니다. 프리셋은 「페르소나 프리셋」 탭에서 만들 수 있어요.',
      },
    },
    genyTools: {
